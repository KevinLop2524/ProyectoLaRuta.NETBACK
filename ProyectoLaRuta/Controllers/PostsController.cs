...
namespace ProyectoLaRuta.Controllers
{
    public class PostsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["CommunityId"] = new SelectList(_context.Communities, "Id", "Category");
        ...
        public async Task<IActionResult> Create([Bind("Contenido,Type")] Post post)
        {
        ...
        public async Task<IActionResult> Edit(long? id)
        {
            ...
            ViewData["CommunityId"] = new SelectList(_context.Communities, "Id", "Category", post.CommunityId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Comentarios,Compartidos,Contenido,FechaCreacion,Likes,Type,FechaActualizacion,AuthorId,CommunityId,ServiceId,UsuarioDestinoId,HasMedia,ImagePublicId,ImageThumbnailUrl,ImageUrl")] Post post)
        {
            if (id != post.Id)
            {
                return NotFound();
